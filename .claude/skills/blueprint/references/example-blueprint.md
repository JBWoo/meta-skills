...
This file contains a real blueprint document generated by the blueprint skill, exactly as produced.
The subject is an n8n workflow automation agent system. Read the annotations below before studying the document.
